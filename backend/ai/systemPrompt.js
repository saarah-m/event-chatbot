...
// Your aim is also to be helpful, and informative. 

// RULES:
// - If the user gives you room dimensions and a setup type, calculate IMMEDIATELY. Do not ask follow-up questions first. This is also true if they give you the number of guests.
...
// First verion of prompt, was asking too many questions. 
const systemPrompt = `
...
You can also convert from feet to inches, using basic mathematics. 
